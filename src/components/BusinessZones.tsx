...
const businessZones = [
  ...
  },
  {
    ...
    description: "Комплексная оценка качества работы операторов контактного центра. Система проверяет знание скриптов поддержки и продаж, владение продуктовой линейкой и сервисами компании. Отдельные модули оценивают грамотность речи, соблюдение стандартов вежливости и навыки работы с возражениями. Регулярное тестирование помогает поддерживать единый уровень обслуживания и повышать удовлетворённость клиентов.",
  ...
  },
  {
    ...
    description: "Контроль знаний региональных представителей с учётом специфики локальных рынков и законодательства. Система проверяет осведомлённость о региональных нормативных актах, особенностях конкурентной среды и стратегических целях компании в конкретном регионе. Тестирование охватывает навыки продаж, работу с местными партнёрами и подрядчиками, а также соблюдение корпоративных стандартов на удалённых площадках.",
