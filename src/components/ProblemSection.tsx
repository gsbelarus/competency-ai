        ...
        <div className="hidden md:grid grid-cols-3 gap-8 max-w-4xl mx-auto">
          {problems.map((p, i) => (
            <div key={i} className="group flex flex-col items-center text-center">
              <div className="w-28 h-28 rounded-full border border-amber-400/30 group-hover:border-amber-400/60 transition-all duration-500 flex items-center justify-center relative mb-4">
                <div className="absolute inset-2 rounded-full bg-amber-400/5 group-hover:bg-amber-400/10 transition-colors duration-500" />
                <p.icon className="w-7 h-7 text-amber-400 group-hover:scale-110 transition-transform duration-300 relative z-10" />
              </div>
        ...
        <div className="md:hidden space-y-6 max-w-md mx-auto">
          {problems.map((p, i) => (
            <div key={i} className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-full border border-amber-400/30 bg-amber-400/5 flex items-center justify-center shrink-0">
